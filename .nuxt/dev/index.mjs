...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, getQuery as getQuery$1, getCookie, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/devalue/index.js';
import destr, { destr as destr$1 } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, withLeadingSlash, withoutTrailingSlash, isRelative, joinRelativeURL } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/klona/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/scule/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/atul/project/atulkhanal.com.np/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/unctx/dist/index.mjs';
import { defineNitroPlugin } from 'nitropack/runtime';
import { extname } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/unified/index.js';
import { toString } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file:///home/atul/project/atulkhanal.com.np/node_modules/slugify/slugify.js';
import remarkParse from 'file:///home/atul/project/atulkhanal.com.np/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/atul/project/atulkhanal.com.np/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/remark-mdc/dist/index.mjs';
import remarkEmoji from 'file:///home/atul/project/atulkhanal.com.np/node_modules/remark-emoji/index.js';
import remarkGFM from 'file:///home/atul/project/atulkhanal.com.np/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///home/atul/project/atulkhanal.com.np/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///home/atul/project/atulkhanal.com.np/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/atul/project/atulkhanal.com.np/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/atul/project/atulkhanal.com.np/node_modules/rehype-raw/index.js';
import { detab } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/detab/index.js';
import { toString as toString$1 } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///home/atul/project/atulkhanal.com.np/node_modules/github-slugger/index.js';
import { version, unref } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/atul/project/atulkhanal.com.np/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/atul/project/atulkhanal.com.np/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/atul/project/atulkhanal.com.np/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/atul/project/atulkhanal.com.np/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/atul/project/atulkhanal.com.np","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/atul/project/atulkhanal.com.np/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/atul/project/atulkhanal.com.np/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/atul/project/atulkhanal.com.np/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/atul/project/atulkhanal.com.np/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _VXGJWmSzNP = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/atul/project/atulkhanal.com.np";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _3VA14ncVNF = (nitroApp) => {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/atul/project/atulkhanal.com.np/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _FxjtYOHQyx = defineNitroPlugin(async (nitro) => {
...
const _cwgBr8 = defineEventHandler(async (event) => {
...
const _Cyn3y8 = defineEventHandler(async (event) => {
...
const _a2T2fd = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_l4PV0F = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_l4PV0F, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _cwgBr8, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _cwgBr8, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _cwgBr8, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _Cyn3y8, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _a2T2fd, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _a2T2fd, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _a2T2fd, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_l4PV0F, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///home/atul/project/atulkhanal.com.np/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/atul/project/atulkhanal.com.np/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
